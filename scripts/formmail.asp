...
<%	'**************************************************************************
	...
	fromAddr   = "lanparty@melbourneit.com"

	allowedHosts      = Array("lanparty.melbourneit.com", "202.148.129.81")
...
<%	'==========================================================================
	...
	function SendMail()
		...
		if mailComp = "ASPEmail" then
		   ...
		   mailObj.From = fromAddr
			mailObj.AddAddress "joe.euston@melbourneit.com.au"
		   ...
		   ' message body
		   mailObj.Body = body
		   if not mailObj.Send then
				Send = "Email send failed: " & mailObj.Response & "."
			end if
			exit function
	   end if
